	...
	public Command makeEditCommand(Model model, String type) {
	  ...
	  */
	  public String getTitle() { 
		  System.out.println("in mazeFactory getTitle(), print fName: "+Utilities.fName);
		  if(Utilities.fName!="" && Utilities.fName !=null) {
			  return "Maze Challenger located:"+ Utilities.fName;
		  }
		  else if(Utilities.fName==null) {
			  System.out.println("in mazeFactory getTitle(), if fName == null");
			  System.out.println("in mazeFactory getTitle(), prefilename fName: " + Utilities.preFileName);
			  return "Maze Challenger" + Utilities.preFileName;
		  }
